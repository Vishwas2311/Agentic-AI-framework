...
- Name: happy-path.spec.ts >> TC_010 - Patient can sign out and is returned to login
- Location: tests\e2e\happy-path.spec.ts:159:5
...
Locator: getByRole('heading', { name: /sign out/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /sign out/i })
